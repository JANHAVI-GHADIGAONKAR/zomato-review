...
// try {
//     const response = await fetch('http://localhost:3000/api?sort=dd&filter=reviews-dd&res_id=19746180&page=1', {
//       method: 'POST',
...
fetch('https://www.zomato.com/webroutes/reviews/loadMore?sort=dd&filter=reviews-dd&res_id=19746180&page=1')
.then(res => {
    console.log(res);
})